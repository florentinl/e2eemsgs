...
export const sym_decrypt_bytes: (a: any, b: number, c: number) => [number, number, number, number];
export const sym_decrypt: (a: any, b: number, c: number) => [number, number, number, number];
