...
function App() {
  ...
  return (
    <Box>
      ...
      <button onClick={onClick} disabled={!isReady}>Derive</button>
      <Box>
        <p>Public Key</p>
        <p>{publicKey}</p>
      </Box>
      ...
      <button onClick={onClickEncrypt} disabled={!isReady}>Encrypt</button>
      <Box>
        <p>Encrypted Bytes</p>
        <p>{cipherBytes?.toString()}</p>
      </Box>
      <button onClick={onClickDecrypt} disabled={!isReady}>Decrypt</button>
      <Box>
        <p>Clear Text</p>
        <p>{clearText}</p>
      </Box>
