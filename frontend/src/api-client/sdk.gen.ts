...
import type { SignupApiAuthSignupPostData, SignupApiAuthSignupPostResponse, SignupApiAuthSignupPostError, ChallengeApiAuthLoginChallengePostData, ChallengeApiAuthLoginChallengePostResponse, ChallengeApiAuthLoginChallengePostError, AnswerApiAuthLoginAnswerPostData, AnswerApiAuthLoginAnswerPostResponse, AnswerApiAuthLoginAnswerPostError, HandleCreateGroupApiGroupsCreatePostData, HandleCreateGroupApiGroupsCreatePostResponse, HandleCreateGroupApiGroupsCreatePostError, HandleAddGroupUserApiGroupsAddPostData, HandleAddGroupUserApiGroupsAddPostResponse, HandleAddGroupUserApiGroupsAddPostError, HandleGetUserGroupsApiGroupsGetData, HandleGetUserGroupsApiGroupsGetResponse, GetGroupUsersApiGroupsUsersGetData, GetGroupUsersApiGroupsUsersGetResponse, GetGroupUsersApiGroupsUsersGetError, GetGroupMessagesApiMessagesGetData, GetGroupMessagesApiMessagesGetResponse, SendMessageApiMessagesPostData, SendMessageApiMessagesPostResponse, SendMessageApiMessagesPostError, WhoamiApiSessionWhoamiGetData, WhoamiApiSessionWhoamiGetResponse, HandleGetUserApiUsersGetData, HandleGetUserApiUsersGetResponse, HandleGetUserApiUsersGetError } from './types.gen';
 ...
 * Get Group Users
 */
export const getGroupUsersApiGroupsUsersGet = <ThrowOnError extends boolean = false>(options: Options<GetGroupUsersApiGroupsUsersGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetGroupUsersApiGroupsUsersGetResponse, GetGroupUsersApiGroupsUsersGetError, ThrowOnError>({
