...
/**
 * Handle Remove Group User
 */
export const handleRemoveGroupUserApiGroupsRemovePost = <ThrowOnError extends boolean = false>(options: Options<HandleRemoveGroupUserApiGroupsRemovePostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<HandleRemoveGroupUserApiGroupsRemovePostResponse, HandleRemoveGroupUserApiGroupsRemovePostError, ThrowOnError>({
...
/**
 * Handle Edit Group Member
 */
export const handleEditGroupMemberApiGroupsEditPost = <ThrowOnError extends boolean = false>(options: Options<HandleEditGroupMemberApiGroupsEditPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<HandleEditGroupMemberApiGroupsEditPostResponse, HandleEditGroupMemberApiGroupsEditPostError, ThrowOnError>({
        url: '/api/groups/edit',
        ...options,
        headers: {
            'Content-Type': 'application/json',
