...
export type BodyUploadApiMessagesUploadPost = {
    file: Blob | File;
    file_nonce: string;
    group_id: number;
    message: string;
...
export type UploadApiMessagesUploadPostData = {
    body: BodyUploadApiMessagesUploadPost;
    path?: never;
    query?: never;
    url: '/api/messages/upload';
};

export type UploadApiMessagesUploadPostErrors = {
    /**
     * Validation Error
     */
    422: HttpValidationError;
...
export type UploadApiMessagesUploadPostError = UploadApiMessagesUploadPostErrors[keyof UploadApiMessagesUploadPostErrors];

export type UploadApiMessagesUploadPostResponses = {
    /**
     * Successful Response
     */
    200: unknown;
...
export type DownloadApiMessagesDownloadPostData = {
...
export type DownloadApiMessagesDownloadPostErrors = {
    /**
     * Validation Error
     */
    422: HttpValidationError;
...
export type DownloadApiMessagesDownloadPostError = DownloadApiMessagesDownloadPostErrors[keyof DownloadApiMessagesDownloadPostErrors];

export type DownloadApiMessagesDownloadPostResponses = {
    /**
     * Successful Response
     */
    200: unknown;
